  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden flex items-center gap-1.5 rounded-lg border border-[#e8ecf0] bg-white px-3 py-1.5 text-xs font-medium text-slate-600 hover:bg-slate-50 transition-colors"
      >
