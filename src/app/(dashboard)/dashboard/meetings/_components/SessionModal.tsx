          ...
          <div className="border-b-[2px] lg:border-b-0 lg:border-r-[2px] border-[#0a0a0a]/15 p-5 flex flex-col gap-3 min-h-0">
            ...
            <div className="flex-1 min-h-0 flex flex-col">
              ...
              <textarea
                ...
                disabled={saving}
                className="flex-1 resize-none border-[2px] border-[#0a0a0a] bg-white p-3 font-mono text-[12.5px] leading-relaxed text-[#0a0a0a] focus:outline-none focus:ring-2 focus:ring-yellow-300 disabled:opacity-60"
              />
              <p className="mt-1 text-[10px] font-mono text-[#0a0a0a]/45 text-right">
