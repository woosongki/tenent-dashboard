...
export const ELAND_META: StoreMeta[] = [
  {
    store_id: 1,
    trade_area: { primary_age: ["60대+"] as AgeBand[], primary_gender: "여성 중심", family_ratio: null },
  ...
  {
    store_id: 2,
    trade_area: { primary_age: ["40대"] as AgeBand[], primary_gender: "여성 중심", family_ratio: null },
  ...
  {
    store_id: 3,
    trade_area: { primary_age: ["50대","40대"] as AgeBand[], primary_gender: "여성 중심", family_ratio: null },
  ...
  {
    store_id: 7,
    trade_area: { primary_age: ["40대","60대+"] as AgeBand[], primary_gender: "여성 중심", family_ratio: null },
  ...
  {
    store_id: 9,
    trade_area: { primary_age: ["60대+","50대"] as AgeBand[], primary_gender: "여성 중심", family_ratio: null },
  ...
  {
    store_id: 10,
    trade_area: { primary_age: ["60대+","40대"] as AgeBand[], primary_gender: "여성 중심", family_ratio: null },
  ...
  {
    store_id: 24,
    trade_area: { primary_age: ["40대","50대"] as AgeBand[], primary_gender: "여성 중심", family_ratio: null },
  ...
  {
    store_id: 36,
    trade_area: { primary_age: ["50대"] as AgeBand[], primary_gender: "여성 중심", family_ratio: null },
